...
<html lang="en">
<head>
    <title>Code coverage report for heroku-apps/commands/apps/open.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">heroku-apps/commands/apps/</a> open.js
    </h1>
    <div class='clearfix'>
...
let url      = require('url');
&nbsp;
<span class="fstat-no" title="function not covered" >function* run (context, heroku) {</span>
<span class="cstat-no" title="statement not covered" >  let app = yield heroku.apps(context.app).info();</span>
<span class="cstat-no" title="statement not covered" >  yield cli.open(url.resolve(app.web_url, context.args.path || ''));</span>
}
&nbsp;
let cmd = {
  topic: 'apps',

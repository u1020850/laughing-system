...
<html lang="en">
<head>
    <title>Code coverage report for heroku-apps/commands/domains/clear.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">heroku-apps/commands/domains/</a> clear.js
    </h1>
    <div class='clearfix'>
...
function* run (context, heroku) {
  yield cli.action(`Removing all domains from ${cli.color.app(context.app)}`, co(function* () {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (domains.length === 0) <span class="cstat-no" title="statement not covered" >return;</span>
    yield bluebird.map(
      domains,

...
<html lang="en">
<head>
    <title>Code coverage report for heroku-apps/commands/regions/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">heroku-apps/commands/regions/</a> index.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    cli.log(JSON.stringify(regions, 0, 2));</span>
  } else {
    cli.table(regions, {
      columns: [

...
<html lang="en">
<head>
    <title>Code coverage report for heroku-apps/lib/error.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">heroku-apps/lib/</a> error.js
    </h1>
    <div class='clearfix'>
...
function exit(code, message) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (mocking) {

...
<html lang="en">
<head>
    <title>Code coverage report for heroku-apps/commands/features/enable.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">heroku-apps/commands/features/</a> enable.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  yield cli.action(`Enabling ${cli.color.green(feature)} for ${cli.color.app(app)}`, co(function* () {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (f.enabled) <span class="cstat-no" title="statement not covered" >throw new Error(`${cli.color.red(feature)} is already enabled.`);</span>
&nbsp;
